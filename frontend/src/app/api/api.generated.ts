...
export class WordsClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ?? "http://localhost:5206/";
    }
    ...
    getAllWords(): Observable<WordResponse[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllWords(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllWords(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<WordResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<WordResponse[]>;
        }));
    }

    protected processGetAllWords(response: HttpResponseBase): Observable<WordResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as WordResponse[];
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Created
     */
    addWord(body: AddWordRequest): Observable<WordResponse> {
        let url_ = this.baseUrl + "/api/Words";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddWord(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddWord(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<WordResponse>;
                }
            } else
    ...
    protected processAddWord(response: HttpResponseBase): Observable<WordResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 201) {
            ...
            result201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as WordResponse;
     ...
     * @return OK
     */
    importWords(file: FileParameter | undefined): Observable<ImportSummary> {
        let url_ = this.baseUrl + "/api/Words/import";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processImportWords(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processImportWords(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ImportSummary>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ImportSummary>;
        }));
    }

    protected processImportWords(response: HttpResponseBase): Observable<ImportSummary> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as ImportSummary;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return No Content
     */
    deleteWords(body: DeleteWordsRequest): Observable<void> {
        let url_ = this.baseUrl + "/api/Words/batch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteWords(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteWords(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processDeleteWords(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return No Content
     */
    clearAllWords(): Observable<void> {
        let url_ = this.baseUrl + "/api/Words/clear";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processClearAllWords(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processClearAllWords(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processClearAllWords(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    regenerateAudio(): Observable<AudioRegenerateSummary> {
        let url_ = this.baseUrl + "/api/Words/regenerate-audio";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRegenerateAudio(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRegenerateAudio(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<AudioRegenerateSummary>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AudioRegenerateSummary>;
        }));
    }

    protected processRegenerateAudio(response: HttpResponseBase): Observable<AudioRegenerateSummary> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as AudioRegenerateSummary;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export interface AudioRegenerateSummary {
    updated: number;
    failed: number;
    failedWords: string[];
